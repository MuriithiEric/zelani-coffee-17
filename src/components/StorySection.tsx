export const StorySection = () => {
  return (
    <section id="story" className="py-24 bg-sand-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-espresso-800 mb-6">
            The Nomad's Journey
          </h2>
          
          <div className="w-20 h-1 bg-forest-600 mx-auto mb-8"></div>
          
          <p className="text-lg md:text-xl text-espresso-700 leading-relaxed mb-6">
            <span className="font-semibold text-forest-700">Zelani</span> means <em>nomad</em> or <em>traveler</em> — 
