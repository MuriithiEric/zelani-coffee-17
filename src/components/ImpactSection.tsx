...
export const ImpactSection = () => {
  ...
  return (
    <section id="impact" className="py-24 bg-forest-900 text-sand-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {impacts.map((impact, index) => (
            <div 
              key={index} 
              className="text-center p-6 rounded-lg bg-forest-800/50 backdrop-blur-sm hover-lift transition-all duration-300"
            >
              <div className="inline-flex items-center justify-center w-16 h-16 bg-sand-400 rounded-full mb-4">
                <impact.icon className="h-8 w-8 text-espresso-900" />
              </div>
              <h3 className="font-playfair text-xl font-semibold mb-3 text-sand-100">
                {impact.title}
              </h3>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-sand-200/10 backdrop-blur-sm rounded-lg p-8 max-w-3xl">
